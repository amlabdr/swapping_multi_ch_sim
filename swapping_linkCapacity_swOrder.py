...
def simulate(network_config,link_capacity=None,swapping_order = None):
    ...
    print("Swapping order:{} => Expected Eg Rate = {}".format(swapping_order, rate))
    return (rate)
...
simulate(network_config,link_capacity,swapping_order = ["r1","r2","r3"])
simulate(network_config,link_capacity,swapping_order = ["r3","r1","r2"])
simulate(network_config,link_capacity,swapping_order = ["r3","r2","r1"])"""